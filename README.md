...
Это обертка вокруг привычного `JDBC`. Идет транзитивно в `Spring Data Jpa Starter`.
В контексте есть бин `JdbcTemplate`, и `NamedParameterJdbcTemplate` - то же самое, только можно
писать именованные параметры.

Основные методы - `execute, query, update`. 
...
### 13.1 In-Memory databases. H2

Лучше использовать такую же субд как на проде, с помощью `Docker`. Но сначала рассмотрим `H2`.

Добавляем зависимость, `hibernate ddl auto update` создаст структуру.

Добавляем аннотацию `@Sql`, она будет накатывать скрипт _**перед каждым тестом**_:
...
Добавляем зависимость `testcontainers`.

> Если у каких-то библиотек все-таки пишем версии, лучше выносить в отдельный файл
...
<img alt="img.png" src="imgs/p16/img.png" width="800"/>
...
<img alt="img_1.png" src="imgs/p16/img_1.png" width="800"/>

Пример:

<img alt="img_2.png" src="imgs/p16/img_2.png" width="800"/>

Если объект `session/application scope`, то пишем сначала их:

<img alt="img_3.png" src="imgs/p16/img_3.png" width="600"/>

### 16.2 CRUD. View Layer. Часть 1

Код контроллера:

<img alt="img_6.png" src="imgs/p16/img_6.png" width="1000"/>

Пример формы на `Thymeleaf`:

<img alt="img_4.png" src="imgs/p16/img_4.png" width="1200"/>

И еще:

<img alt="img_5.png" src="imgs/p16/img_5.png" width="1200"/>

### 16.4 Filter Query

> Когда пишем форму с методом `GET`, при `submit` значения добавляются как параметры `url`

<img alt="img_8.png" src="imgs/p16/img_8.png" width="800"/>

<img alt="img_7.png" src="imgs/p16/img_7.png" width="1000"/>
...
или `@Validated` (от спринга)

Чтобы самостоятельно контролировать обработку ошибок, можно поставить
**сразу после валидируемого объекта** объект `Binding result` и 
самостоятельно работать с ним 

### 17.2 Custom validator
