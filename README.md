...
> 1. **Безопасность NPE:** Зависимости через конструктор гарантированно инициализированы при создании бина, их можно сделать final. @Autowired может оставить поля null, если зависимость не найдена
